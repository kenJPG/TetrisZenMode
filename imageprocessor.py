	...
	def wait_go(self):
		...
		while yellow_count < 2:
			...
			for val in go_x:
				...
				img[go_y][val] = [255, 255, 255]
				img[go_y + 1][val] = [255, 255, 255]
				img[go_y + 1][val + 1] = [255, 255, 255]
				img[go_y][val + 1] = [255, 255, 255]

			if done:
				cv2.imwrite("gocheck.jpg", img)
				done = False
		...
		while True:
			...
			cv2.imwrite("nongocheck.jpg", img)
			if go_check_count == 0:
				break
